...
public class PlayerModel : PageModel
{
    ...
    public PlayerModel(IConfiguration config, AzureBlobStorageService storageService)
    {
        _config = config;
    ...
    public async Task OnGetAsync(string? container = null, bool autoplay = true)
    {
        ...
        try
        {
            ...
            // Debug output
            Console.WriteLine($"Player - Container: {ContainerName}");
            Console.WriteLine($"Player - Found {VideoNames.Count()} videos");
        ...
        {
            Console.WriteLine($"Player - Error getting videos: {ex.Message}");
